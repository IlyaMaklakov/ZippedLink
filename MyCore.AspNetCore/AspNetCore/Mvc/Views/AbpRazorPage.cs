...
namespace MyCore.AspNetCore.Mvc.Views
{
    /// <summary>
    ...
    public abstract class AbpRazorPage<TModel> : RazorPage<TModel>
    {
        ...
        {
            get { return this._localizationSource.Name; }
            set { this._localizationSource = LocalizationHelper.GetSource(value); }
        }
        ...
        {
            return this._localizationSource.GetString(name, args);
        }
        ...
        {
            return this._localizationSource.GetString(name, culture);
        }
        ...
        {
            return this._localizationSource.GetString(name, culture, args);
        }
        ...
        {
            return this.LocalizationManager.GetSource(sourceName).GetString(name);
        }
        ...
        {
            return this.LocalizationManager.GetSource(sourceName).GetString(name, args);
        }
        ...
        {
            return this.LocalizationManager.GetSource(sourceName).GetString(name, culture);
        }
        ...
        {
            return this.LocalizationManager.GetSource(sourceName).GetString(name, culture, args);
        }
