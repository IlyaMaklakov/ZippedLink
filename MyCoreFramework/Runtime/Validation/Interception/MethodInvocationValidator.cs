...
namespace MyCoreFramework.Runtime.Validation.Interception
{
    ...
    public class MethodInvocationValidator : ITransientDependency
    {
        ...
        public MethodInvocationValidator(IValidationConfiguration configuration, IIocResolver iocResolver)
        {
            ...
            this.ObjectsToBeNormalized = new List<IShouldNormalize>();
        }
        ...
        public void Validate()
        {
            ...
            foreach (var objectToBeNormalized in this.ObjectsToBeNormalized)
            {
        ...
        {
            if (this.Method.IsDefined(typeof(EnableValidationAttribute), true))
            {
                return false;
            }

            return ReflectionHelper.GetSingleAttributeOfMemberOrDeclaringTypeOrDefault<DisableValidationAttribute>(this.Method) != null;
        }
        ...
        protected virtual void ValidateObjectRecursively(object validatingObject)
        {
            ...
            this.SetDataAnnotationAttributeErrors(validatingObject);
            ...
            {
                this.ObjectsToBeNormalized.Add(validatingObject as IShouldNormalize);
            }
            ...
            if (this._configuration.IgnoredTypes.Any(t => t.IsInstanceOfType(validatingObject)))
            {
                return;
            }
        ...
        protected virtual void SetDataAnnotationAttributeErrors(object validatingObject)
        {
            ...
            if (validatingObject is IValidatableObject)
            {
                ...
                this.ValidationErrors.AddRange(results);
            }
        }
    }
}
