...
namespace MyCoreFramework
{
    ...
    public class UserIdentifier : IUserIdentifier
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.TenantId == other.TenantId && this.UserId == other.UserId;
        }

        /// <inheritdoc/>
        public override int GetHashCode()
        {
            return this.TenantId == null ? (int)this.UserId : (int)(this.TenantId.Value ^ this.UserId);
        }
        ...
        {
            return this.ToUserIdentifierString();
        }
    }
}
