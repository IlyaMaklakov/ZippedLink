...
namespace MyCoreFramework.Notifications
{
    ...
    public class NotificationSubscriptionInfo : CreationAuditedEntity<Guid>, IMayHaveTenant
    {
        ...
        public NotificationSubscriptionInfo(int? tenantId, long userId, string notificationName, EntityIdentifier entityIdentifier = null)
        {
            ...
            this.UserId = userId;
            this.EntityTypeName = entityIdentifier == null ? null : entityIdentifier.Type.FullName;
            this.EntityTypeAssemblyQualifiedName = entityIdentifier == null ? null : entityIdentifier.Type.AssemblyQualifiedName;
            this.EntityId = entityIdentifier == null ? null : entityIdentifier.Id.ToJsonString();
        }
    }
}