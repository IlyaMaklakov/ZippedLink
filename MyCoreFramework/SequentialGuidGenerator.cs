...
using MyCoreFramework.Threading.Extensions;
...
namespace MyCoreFramework
{
    ...
    public class SequentialGuidGenerator : IGuidGenerator
    {
        ...
        {
            this.DatabaseType = SequentialGuidDatabaseType.SqlServer;
        }
        ...
        public Guid Create(SequentialGuidDatabaseType databaseType)
        {
            switch (databaseType)
            {
                case SequentialGuidDatabaseType.SqlServer:
                    return this.Create(SequentialGuidType.SequentialAtEnd);
                case SequentialGuidDatabaseType.Oracle:
                    return this.Create(SequentialGuidType.SequentialAsBinary);
                case SequentialGuidDatabaseType.MySql:
                    return this.Create(SequentialGuidType.SequentialAsString);
