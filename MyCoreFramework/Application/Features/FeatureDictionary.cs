...
namespace MyCoreFramework.Application.Features
{
    ...
    public class FeatureDictionary : Dictionary<string, Feature>
    {
        ...
        {
            foreach (var feature in this.Values.ToList())
            {
                this.AddFeatureRecursively(feature);
            }
        }
        ...
        private void AddFeatureRecursively(Feature feature)
        {
            ...
            if (this.TryGetValue(feature.Name, out existingFeature))
            {
            ...
            {
                this.AddFeatureRecursively(childFeature);
            }
        }
    }
}