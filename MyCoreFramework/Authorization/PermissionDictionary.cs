...
namespace MyCoreFramework.Authorization
{
    ...
    internal class PermissionDictionary : Dictionary<string, Permission>
    {
        ...
        {
            foreach (var permission in this.Values.ToList())
            {
                this.AddPermissionRecursively(permission);
            }
        }
        ...
        private void AddPermissionRecursively(Permission permission)
        {
            ...
            if (this.TryGetValue(permission.Name, out existingPermission))
            {
            ...
            {
                this.AddPermissionRecursively(childPermission);
            }
        }
    }
}