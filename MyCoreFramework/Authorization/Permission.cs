...
namespace MyCoreFramework.Authorization
{
    ...
    public sealed class Permission
    {
        ...
        /// </summary>
        public IReadOnlyList<Permission> Children => this._children.ToImmutableList();
            ...
            IFeatureDependency featureDependency = null)
        {
            ...
            this._children = new List<Permission>();
        }
            ...
            IFeatureDependency featureDependency = null)
        {
            ...
            this._children.Add(permission);
            return permission;
        }

        public override string ToString()
        {
            return string.Format("[Permission: {0}]", this.Name);
        }
    }
}
