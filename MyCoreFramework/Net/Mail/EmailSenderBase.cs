...
namespace MyCoreFramework.Net.Mail
{
    ...
    public abstract class EmailSenderBase : IEmailSender
    {
        ...
        {
            await this.SendAsync(this._configuration.DefaultFromAddress, to, subject, body, isBodyHtml);
        }

        public void Send(string to, string subject, string body, bool isBodyHtml = true)
        {
            this.Send(this._configuration.DefaultFromAddress, to, subject, body, isBodyHtml);
        }
        ...
        protected virtual void NormalizeMail(MailMessage mail)
        {
            if (mail.From == null || mail.From.Address.IsNullOrEmpty())
            {
                mail.From = new MailAddress(
                    this._configuration.DefaultFromAddress,
                    this._configuration.DefaultFromDisplayName,
                    Encoding.UTF8
                    );
            }
