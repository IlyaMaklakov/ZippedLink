...
namespace MyCoreFramework.Localization
{
    ...
    public class LocalizableString : ILocalizableString
    {
        ...
        {
            return context.LocalizationManager.GetString(this.SourceName, this.Name);
        }

        public string Localize(ILocalizationContext context, CultureInfo culture)
        {
            return context.LocalizationManager.GetString(this.SourceName, this.Name, culture);
        }

        public override string ToString()
        {
            return string.Format("[LocalizableString: {0}, {1}]", this.Name, this.SourceName);
        }
    }
}
